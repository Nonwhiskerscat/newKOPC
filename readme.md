...
<div align="justify">
<br>
  <p align="justify"><a href="https://github.com/Nonwhiskerscat">키드캣</a>의 첫 번째 프로젝트, 고양이 보호협회 페이지 리뉴얼 대작전!, <s>어...? 그러면 좀 이상한가?</s> 안녕하십니까, 해당 프로젝트를 맡은 <b>수염 없냥</b>입니다. 처음 이 프로젝트를 맡게 되었을 때, HTML, CSS가 익숙하지 않았고, 제이쿼리에서 '제'자도 모르는 초보 개발자였습니다. 물론 웹 페이지를 완성하긴 했지만, 약간 아쉬움이 드는 프로젝트라고도 생각합니다. 지금부터 고양이 보호협회 페이지 리뉴얼 홈페이지에 대해 설명하겠습니다. <s>어이 거기 페이지 접속한 닝겐아, 뒤로가기 누르지 말고 스크롤바를 내리라냥!</s></p>
</div>
...
> <h3>소감&nbsp&nbsp:wind_chime:</h3>
> <p align="justify">
> <div align="center">
> <h4>2년 간 묵혀왔던 나의 바램이 해결되었다. 그러나...</h4>
> </div>
> 사실 저는 이 웹페이지는 2년 전부터 알게 되었고 적어도 일주일에 한 번 이상 해당 웹 사이트를 방문했습니다. 하지만 2000년대 중후반에 제작되었다 해도 믿을 정도로 웹 페이지의 UX/UI가 원시적이었습니다. 저는 이 부분이 매우 아쉽다 생각하였고, <b>웹 페이지의 디자인이 트렌디하게 바뀌었으면 후원하고자 하는 회원이 지금보다 훨씬 더 많을 것</b>이라는 생각을 종종 했습니다. 그래서 이번에 바꾸었습니다. 주위에서는 이전의 페이지보다 훨씬 낫다는 피드백을 받아 매우 뿌듯했습니다. 하지만 실제 웹 사이트에 호스팅 되기에는 디자인, 인터페이스적으로 많이 모자르다 생각하지만, 첫 번째 포트폴리오를 문제 없이 완수하였다는 것 자체가 매우 경이로웠습니다.  
></p>

<br>

> <h3>개선된 점&nbsp&nbsp:balloon:</h3>
> <p align="justify">HTML, CSS 역량이 향상되어 여느 사이트 웹 페이지도 신설, 리뉴얼 할 수 있다는 자신감을 얻었습니다. 그리고 코딩 역량 뿐만 아니라 디자인 역량도 한 층 더 높아진 것 같습니다. 물론 당장 디자이너로서 실무로 투입될 만큼의 디자인은 아니지만, <a href="https://github.com/Nonwhiskerscat/TT">제 졸업 작품</a>과 대학 4년 내내 디자인 했던 결과물 <s>보여주기 부끄러워서...</s>에 비하면 선녀라고 해도 될 정도로 디자인 실력 또한 어느 정도 개선된 것 같습니다.</p>
</div>
<br>

> <h3>반성할 점&nbsp&nbsp:tanabata_tree:</h3>
> <p align="justify">J-Query를 처음 사용해봤다는 이유로 남의 코드를 그대로 베껴온 것이 패착이 된 것 같습니다. 시간적인 여유만 있다면 기존의 코드를 모두 <b>바닐라 자바스크립트</b>로 갈아 끼우고 싶다. 하지만 질 보다 양이기 때문에 코드 하나 고칠 시간에 프로젝트를 하나 더 만드는 편이 나은 것 같습니다. ㅎㅎ. 그리고 접근성을 위해 화이트모드, 다크모드를 구현했지만 이거 하나 구현하려고 html, css, jquery 파일을 하나씩 더 만들었다. 물론 실제 직무에 투입될 때 이따구로 하면 싸대기를 얻어 맞겠죠 ㅎㅎ. 마지막으로 코린이라는 이유로 <b>플러그인을 때려박은 것</b>도 약간 아쉽다 생각합니다.</p>
<br>

> <h3>뒷 이야기&nbsp&nbsp:crystal_ball:</h3>
> <p align="justify">경이롭게도 프로젝트 이전에 <b>수염 없냥은 이 페이지를 알고 있었다.</b>.:scream_cat: 심지어 <b>회원으로 가입하여 후원까지 하고 있었습니다. <s>후원 아이디는 nonwhiskerscat입니다.</s> </b>. :scream_cat::scream_cat: 더 놀라운 것은... 아... 뭐였더라?... 아무튼 매번 방문하는 사이트니까, 리뉴얼이 쉽기는 개뿔... 디자인 짜 내느라 죽는 줄 알았다.그래도 내가 좋아하는 고양이니까, 힘들지가 않았다 ㅎㅎ.</p>
<br>
...
<p align="justify">전체적으로 플러그인을 가져다쓰고, 제이쿼리 부분에서 타 개발자의 코드를 그대로 가져다 썼다는 점에서 여러 모로 아쉬운 프로젝트였습니다. 하지만 디자인만 할 줄 알고 그 마저도 실무에 전혀 써 먹을 수 없을 정도로 개판으로 했던 제가 비록 메인페이지지만 <b>웹 페이지를 리뉴얼하여 직접 호스팅 하였다는 것 자체가 아직까지 믿기지 않고 놀라울 따름입니다.</b> 비록 처음이라 많은 시행착오가 있었고 프로젝트 진행 내내 난해함을 느꼈지만, 그래도 제가 좋아하는 고양이를 대상으로 프로젝트를 진행하였기 때문에 전혀 힘들지는 않았습니다 ㅎㅎ. 잡담은 여기까지 하고, 지금까지 재미 없고 장황한 글 읽어주신 여러분에 감사를 표합니다.</p>
